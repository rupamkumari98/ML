...
# Importing all libraries and extensions required for this programming exercise. Throughout the course, we will be using numpy, pandas, and scipy stats for operations.
...
# Congratulations! One can learn now how to use Python to construct a confidence interval for a point estimate.
