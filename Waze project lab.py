...
# To conduct a two-sample hypothesis test (t-test) to analyze the difference in the mean amount of rides between iPhone users and Android users.
...
# Descriptive statistics lets one know the datatypes, unique values, missing values and other statistical measures.
# 
...
# H0:There is no difference in the mean amount of rides between iPhone users and Android users.
# 
# H1:There is difference in the mean amount of rides between iPhone users and Android users.
# 
...
# 1. Isolate the `drives` column for iPhone users.
### YOUR CODE HERE ###
iphone_drives= df[df["device_type"]==1]
# 2. Isolate the `drives` column for Android users.
### YOUR CODE HERE ###
android_drives= df[df["device_type"]==2]
# 3. Perform the t-test
### YOUR CODE HERE ###
stats.ttest_ind(a= iphone_drives["drives"],b= android_drives["drives"], equal_var= False)


# **Question:** Based on the p-value you got above, do you reject or fail to reject the null hypothesis?

# As p-value is greater than significance_level, one is fail to reject the Null Hypothesis.
...
# Result: There is statistically no difference in the mean amount of rides between iPhone users and Android users.
